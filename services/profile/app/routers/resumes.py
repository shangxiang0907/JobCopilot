...
from app.schemas.resume import ResumeActivate, ResumeResponse
from app.services import embedding, file_storage, resume_parser
...
async def upload_resume(
    ...
    parsed = await asyncio.get_event_loop().run_in_executor(
        None, resume_parser.parse, file_url
    )
